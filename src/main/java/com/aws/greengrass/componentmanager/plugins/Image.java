...
public class Image {
     ...
     * @param setAllLeftWhenSeparatorAbsent When separator is not present, if true, all of source string will be set as
     *                                      the first return value. If false, all of source string will be set as the
     *                                      second return value.
     * @param defaultWhenSeparatorAbsent    When separator is not present, use return this value for the other return
     *                                      value than the one assigned with all of source string
